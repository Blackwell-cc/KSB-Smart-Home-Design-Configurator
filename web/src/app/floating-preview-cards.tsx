...
export function FloatingPreviewCards({ showcase }: { showcase: Showcase }) {
  return (
    <div aria-label="ตัวอย่างหน้าจอวางแผนบ้าน" className={styles.previewCards} role="group">
      <div className={`${styles.cardFloat} ${styles.stylePosition}`}><article className={`${styles.previewCard} ${styles.cardReveal}`}>
      ...
      <div className={`${styles.cardFloat} ${styles.areaPosition}`}><article className={`${styles.previewCard} ${styles.cardReveal}`}>
      ...
      <div className={`${styles.cardFloat} ${styles.materialPosition}`}><article className={`${styles.previewCard} ${styles.cardReveal}`}>
      ...
      <div className={`${styles.cardFloat} ${styles.budgetPosition}`}><article className={`${styles.previewCard} ${styles.budgetCard} ${styles.cardReveal}`}>
      ...
      <div className={`${styles.cardFloat} ${styles.sharePosition}`}><article className={`${styles.previewCard} ${styles.shareCard} ${styles.cardReveal}`}>
