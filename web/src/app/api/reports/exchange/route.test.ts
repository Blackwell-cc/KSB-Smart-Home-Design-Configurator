...
const request = (body: unknown, headers: Record<string, string> = { "content-type": "application/json" }) => new NextRequest("https://ksb.test/api/reports/exchange", { method: "POST", headers, body: typeof body === "string" ? body : JSON.stringify(body) });
